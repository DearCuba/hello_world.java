 ...
 * counterAggregation.
 * <p>
 * (+) Реализовать класс счетчика, который хранит: (+) название (name) (+) значение (value) (+)
 * единицы измерения (units) (+) название счетчика и его единицы измерения должны быть неизменны (+)
...
public class Counter {
  ...
  //   Создаем методы класса (геттеры и сеттеры)
